...
module.exports = {
  ...
  async execute(message, args, cmd, client, Discord, profileData) {
    ...
    try {
      ...
      let subscriberCheck = await axios.get(
        `https://api.ivr.fi/twitch/subage/${user}/${broadcaster}`
      );
      if (subscriberCheck.data['subscribed'] == false) {
        ...
        if (oldsub['months'] === 0) {
          ...
          const embed = new Discord.MessageEmbed()
            ...
            .addField(
              'Previously subbed for',
              `‎‏‏‎ ‎‏‏‎ ‎‏‏‎ ‎‏‏‎ ‎‏‏‎ ‎‏‏‎ ‎‏‏‎ ‎‏‏‎ ‎‏‏‎ ‎‏‏‎ ‎‏‏‎ ‎‏‏‎ ${oldsub['months']} months`,
              true
            )
            .setURL(`https://api.ivr.fi/twitch/subage/${user}/${broadcaster}`)
            .setTimestamp()
      ...
      message.reply(
        `make sure to use the correct format: ${process.env.PREFIX}subage, sa [user] [channel].`
      );
    }
  },
};
